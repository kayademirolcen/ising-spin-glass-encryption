...
This project treats computation as a physical process, not a black box.  
We are not encrypting with AES or RSA; we are coaxing a physical system to hide information in its structure.
...
Every notebook builds up intuition before the math.  
If you have ever wanted to see physics, computation, and cryptography intertwine in real time, this is your playground.
...
| `03_Quantum_Annealing.ipynb` | Using quantum circuits, for example QAOA or adiabatic evolution, to reach ground states more efficiently. |
...
The main focus right now is building robust visualizations and benchmarking the Ising encoding and decoding pipeline.  
...
If something does not make sense, open an issue.  
Not everything here is meant to be perfect; it is meant to be understood.
